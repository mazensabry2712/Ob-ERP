...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Edit Project</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    Projects</span>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="yourFormId" action="{{ route('project.update', $project->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="pr_number" name="pr_number"
                                    value="{{ $project->pr_number }}" title="    Please enter the project number  ">
                            </div>
                            <div class="col">
                                <label for="name" class="control-label">PR Name </label>
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ $project->name }}" title="   Please enter the project name  ">
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <label for="vendors" class="control-label">Vendors</label>
                                <select name="vendors_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($vendors as $vendor)
                                        <option value="{{ $vendor->id }}" @selected($project->vendors_id == $vendor->id)>
                                            {{ $vendor->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="customer_po" name="customer_po"
                                    value="{{ $project->customer_po }}" title="   Please enter the  customer po  ">
                            </div>
                            <div class="col">
                                <label for="value" class="control-label">Value </label>
                                <input type="number" class="form-control" id="value" name="value"
                                    value="{{ $project->value }}" title="   Please enter the project value  ">
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="customer_contact_details"
                                    value="{{ $project->customer_contact_details }}" name="customer_contact_details"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="customer_po_duration"
                                    name="customer_po_duration"
                                    title="   Please enter the  Customer PO duration "value="{{ $project->customer_po_duration }}">
                            </div>
