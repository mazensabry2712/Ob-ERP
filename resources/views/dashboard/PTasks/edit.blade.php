...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">update ptask </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    ptask</span>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="yourFormId" action="{{ route('ptasks.update',$ptasks->id) }}" method="post"
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="invoice_number" name="task_date"
                                    title="   Please enter the   " value="{{ $ptasks->task_date}}">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="details" name="details"
                                    title="   Please enter the details  " value="{{ $ptasks->details}}">
                            </div>
                          ...
                          <div class="col">
                                ...
                                <select name="pr_number" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($projects as $pr_number_id)
                                        <option value="{{ $pr_number_id->id }}" @selected($ptasks->pr_number == $pr_number_id->id)> {{ $pr_number_id->pr_number }}</option>
                                    @endforeach
                                </select>
                            </div> 
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="assigned" name="assigned"
                                    title="   Please enter the Status " value="{{ $ptasks->assigned}}">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="expected_com_date" name="expected_com_date"
                                    title="   Please enter the expected_com_date " value="{{ $ptasks->expected_com_date}}">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select class="form-control SlectBox"onclick="console.log($(this).val())"
                                    ...
                                    <option value="completed" @selected($ptasks->status == "completed")>completed</option>
                                    <option value="pending" @selected($ptasks->status == "pending")>pending</option>
                                    <option value="progress" @selected($ptasks->status == "progress")>progress</option>
                                    <option value="hold" @selected($ptasks->status == "hold")>hold</option>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary"> update Ptask </button>
                        </div>
