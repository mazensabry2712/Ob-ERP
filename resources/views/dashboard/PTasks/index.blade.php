            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <a class=" btn btn-outline-primary btn-block" 
                        href="{{ route('ptasks.create') }}"> Add ptask </a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                ...
                                <tr>
                                    <th>#</th>
                                    <th>ptasks Operations </th>
                                    <th> task_date</th>
                                    <th> details</th>
                                    <th> assigned </th>
                                    <th> expected_com_date </th>
                                    <th> status </th>
                                    <th> project_id</th>
                                ...
                                @foreach ($ptasks as $x)
                                    ...
                                    <td>
                                        ...
                                        <a class=" btn btn-sm btn-info" 
                                            ...
                                            href="{{ route('ptasks.edit',$x->id) }}" title="Upadte"><i
                                                class="las la-pen"></i></a>
                                        {{-- @endcan --}}

                                        {{-- @can(' ') --}}
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-id="{{ $x->id }}" data-name="{{ $x->task_date }}"
