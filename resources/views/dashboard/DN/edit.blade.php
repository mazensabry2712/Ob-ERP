                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="dn_number" name="dn_number"
                                    title="   Please enter the dn number " value="{{$dn->dn_number}}">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="pr_number" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($projects as $pr_numberr)
                                        <option value="{{ $pr_numberr->id }}"  @selected($dn->pr_number == $pr_numberr->id)> {{ $pr_numberr->pr_number }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="status" name="status"
                                    title="   Please enter the  status  " value="{{$dn->status}}">
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col">
