...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="yourFormId" action="{{ route('pepo.update',$Pepo->id) }}" method="post"
                        ...
                        <div class="row mt-3">
                        <div class="col">
                                <label for="expected_com_date" class="control-label">planned_cost </label>
                            ...
                            <div class="col">
                                <label for="" class="control-label">selling_price </label>
