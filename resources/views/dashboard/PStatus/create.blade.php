...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="yourFormId" action="{{ route('pstatus.store') }}" method="post"
                        ...
                        <div class="row mt-3">
                            ...
                            <!-- <div class="col">
                                <label for="pm_name" class="control-label">pm_name</label>
                                <input type="text" class="form-control" id="pm_name" name="pm_name"
                                    title="   Please enter the pm_name  ">
                            </div>
                        </div> -->
                        <div class="col">
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="expected_completion" name="expected_completion"
                                    title="   Please enter the expected_completion ">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="test" class="form-control" id="date_pending_cost_orders " name="date_pending_cost_orders"
                                    title="   Please enter the date_pending_cost_orders  ">
                            </div>
                        </div>
